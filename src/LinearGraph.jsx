      ...
      <div className="w-full max-w-7xl grid gap-12 grid-cols-1 lg:grid-cols-2">
        ...
        {[1, 2].map((chartIndex) => (
          ...
          >
            ...
            {/* Only render chart for the first element */}
            {chartIndex === 1 ? (
              <>
                <div className="w-full h-[480px] bg-gradient-to-b from-[#e3f6f5] to-[#ffffff] rounded-xl px-10 py-10 flex items-end justify-center relative overflow-hidden">
                  <ResponsiveContainer>
                  ...
                  <div className="absolute top-1/2 left-[35%] transform -translate-y-1/2 -translate-x-1/2 pointer-events-none flex items-center gap-4">
                ...
                <div className="mt-10 flex justify-end text-xs text-gray-700 items-center gap-2">
              ...
              <div className="h-[480px] bg-gray-50 rounded-xl flex items-center justify-center text-gray-400 text-sm italic">
