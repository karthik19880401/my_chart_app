...
export default function LinearGraph() {
  ...
  return (
    <div className="min-h-screen bg-white font-[Calibri] py-32 px-20 relative">
      {/* Fixed Header */}
      <header className="fixed top-0 left-0 w-full bg-white shadow-md border-b border-gray-200 z-50 p-6">
        ...
        <p className="text-sm text-gray-700 leading-relaxed max-w-5xl">
          ...
          chacune des étapes est à appliquer consciencieusement, elle est décrite sur le panel à droite. La ligne verticale
          du graph vous permet de voir les différents groupes d'affectation et leur temps d'intervention, le graph sinusoidal
          vous montre le temps de traitement, la différence entre le temps de traitement d'une phase prétablie et le temps
          pris pour le faire.
        </p>
      </header>
          ...
          >
            <div className="flex justify-between items-start mb-3">
              ...
              <div className="flex flex-col items-end">
                <h2 className="text-sm font-extrabold text-gray